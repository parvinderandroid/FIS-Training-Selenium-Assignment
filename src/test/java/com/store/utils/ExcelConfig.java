	...
	public static Object[][] readFromExcel(String filePath, String sheetName) throws IOException {
		...
		for (int i = 1; i <= rowCount; i++) {
			...
			for (int j = 0; j < row.getLastCellNum(); j++) {
				 ...
				 * 
				 * case STRING: dataVal.put(String.valueOf(cell1.getStringCellValue()),
				 * String.valueOf(row.getCell(j).getStringCellValue())); break;
				 * 
				 * case NUMERIC:
				 * dataVal.put(String.valueOf(cell1.getNumericCellValue()),String.valueOf(row.
				 * getCell(j).getNumericCellValue())); break;
				 * 
				 * case BOOLEAN:
				 * dataVal.put(String.valueOf(cell1.getBooleanCellValue()),String.valueOf(row.
				 * getCell(j).getBooleanCellValue())); break;
				 * 
				 * case FORMULA:
				 * dataVal.put(String.valueOf(cell1.getCellFormula()),String.valueOf(row.getCell
				 * (j).getCellFormula())); break;
				 * 
